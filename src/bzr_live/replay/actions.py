...
# brings the time fields back with it (measured at 63abb94e). The two restricted bugs in
# this repository are both test fixtures -- verify-cc-order and verify-groups-update -- and
# neither declares a time field, so every bug that reaches this table is anonymously
# readable and the floor is what the code assumes.
#
